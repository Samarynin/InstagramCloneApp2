...
import ru.kaita.instagramcloneapp.AddStoryActivity
import ru.kaita.instagramcloneapp.MainActivity
import ru.kaita.instagramcloneapp.Model.Story
import ru.kaita.instagramcloneapp.Model.User
import ru.kaita.instagramcloneapp.R
import ru.kaita.instagramcloneapp.StoryActivity
                    ...
                    RecyclerView.Adapter<StoryAdapter.ViewHolder>()
{
    ...
    private fun myStories(textView: TextView, imageView: ImageView, click : Boolean)
    {
        val storyRef = FirebaseDatabase.getInstance().reference
            .child("Story").child(FirebaseAuth.getInstance()
                .currentUser!!.uid)
