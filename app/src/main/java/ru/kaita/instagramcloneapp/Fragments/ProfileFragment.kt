...
import ru.kaita.instagramcloneapp.AccountSettingsActivity
import ru.kaita.instagramcloneapp.Adapter.MyImagesAdapter
import ru.kaita.instagramcloneapp.Model.Post
import ru.kaita.instagramcloneapp.Model.User

import ru.kaita.instagramcloneapp.R
import ru.kaita.instagramcloneapp.ShowUsersActivity
import java.util.*
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val linearLayoutManager: GridLayoutManager = GridLayoutManager(context, 3)
        ...
        var uploadedImgesButton: ImageButton
        uploadedImgesButton = view.findViewById(R.id.images_grid_view_btn)
        uploadedImgesButton.setOnClickListener {
            recyclerViewSavedImages.visibility = View.GONE
            recyclerViewUploadImages.visibility = View.VISIBLE
        }

        var savedImgesButton: ImageButton
        savedImgesButton = view.findViewById(R.id.images_save_btn)
        savedImgesButton.setOnClickListener {
