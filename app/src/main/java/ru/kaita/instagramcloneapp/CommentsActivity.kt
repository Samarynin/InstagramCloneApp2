...
import ru.kaita.instagramcloneapp.Adapter.CommentAdapter
import ru.kaita.instagramcloneapp.Model.Comment
...
class CommentsActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        post_comment.setOnClickListener(View.OnClickListener {
            ...
            {
                Toast.makeText(this@CommentsActivity, "Please write your comment", Toast.LENGTH_LONG)
    ...
    {
        val usersRef = FirebaseDatabase.getInstance().reference.child("Users").child(this.firebaseUser!!.uid)
